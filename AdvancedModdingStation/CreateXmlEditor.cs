...
{
    class CreateXmlEditor
    {
        MainForm form;
        Scintilla TextArea;

        public CreateXmlEditor(MainForm form)
        {
            this.form = form;
        }
        ...
        private void InitSyntaxColoring()
        {
            ...
            // Configure the CPP (C#) lexer styles
            TextArea.Styles[Style.Xml.Asp].ForeColor = IntToColor(0xD0DAE2);
            TextArea.Styles[Style.Xml.AspAt].ForeColor = IntToColor(0xBD758B);
            TextArea.Styles[Style.Xml.Attribute].ForeColor = IntToColor(0xff8400);
            TextArea.Styles[Style.Xml.AttributeUnknown].ForeColor = IntToColor(0xE95454);
            TextArea.Styles[Style.Xml.CData].ForeColor = IntToColor(0x2FAE35);
            TextArea.Styles[Style.Xml.Comment].ForeColor = IntToColor(0x40BF57);
            TextArea.Styles[Style.Xml.Default].ForeColor = IntToColor(0x000000);
            TextArea.Styles[Style.Xml.DoubleString].ForeColor = IntToColor(0xff00ff);
            TextArea.Styles[Style.Xml.Entity].ForeColor = IntToColor(0xE95454);
            TextArea.Styles[Style.Xml.Number].ForeColor = IntToColor(0xFFFF00);
            TextArea.Styles[Style.Xml.Other].ForeColor = IntToColor(0x858585);
            TextArea.Styles[Style.Xml.Question].ForeColor = IntToColor(0xE0E0E0);
            TextArea.Styles[Style.Xml.Script].ForeColor = IntToColor(0xFFFF00);
            TextArea.Styles[Style.Xml.SingleString].ForeColor = IntToColor(0xFFFF00);
            TextArea.Styles[Style.Xml.Tag].ForeColor = IntToColor(0x327fff);
            TextArea.Styles[Style.Xml.TagEnd].ForeColor = IntToColor(0x327fff);
            TextArea.Styles[Style.Xml.TagUnknown].ForeColor = IntToColor(0x48A8EE);
            TextArea.Styles[Style.Xml.Value].ForeColor = IntToColor(0xff00ff);
            TextArea.Styles[Style.Xml.XcComment].ForeColor = IntToColor(0xB3D991);
            TextArea.Styles[Style.Xml.XmlEnd].ForeColor = IntToColor(0x48A8EE);
            TextArea.Styles[Style.Xml.XmlStart].ForeColor = IntToColor(0x48A8EE);

            //TextArea.Lexer = Lexer.Cpp;
            TextArea.Lexer = Lexer.Xml;

            TextArea.SetKeywords(0, "property name");
            TextArea.SetKeywords(1, "value");
        ...
        private void LoadDataFromMemory(string data)
        {
            TextArea.Text = data;
        }
        ...
        private void LoadDataFromFile(string path)
        {
            if (File.Exists(path))
            {
                //form1.tabControl.SelectedTab.Text = Path.GetFileName(path);
